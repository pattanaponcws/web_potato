...
function Receive_card({ menu, accept,setreload }) {
  ...
  return (
    <>
      <div className="group h-80 w-full [perspective:1000px] lg:px-10">
        <div className=" relative bg-amber-200 w-full h-80 rounded-xl shadow-lg transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                ...
                {menu.map((item, inxdex) => {
                  ...
                  return (
                    <li className="flex justify-between items-center gap-x-3">
                      ...
                      <div className="text-base sm:text-lg">{item.price} $</div>
                    </li>
                  );
                })}
